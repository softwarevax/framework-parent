...
import org.softwarevax.framework.rpc.protocol.http.ResponseEntity;
...
public class HttpHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        try {
            ...
            String contentType = PropertyUtils.getValIgnoreCase(PropertyUtils.parse(entity.getHeaders()), Constants.DEFAULT_CONTENT_TYPE_KEY);
            if(StringUtils.isBlank(contentType)) {
                headers.put(Constants.DEFAULT_CONTENT_TYPE_KEY, Constants.DEFAULT_CONTENT_TYPE_VAL);
            } else {
    ...
    private Object parseBody(Object obj, String contentType) {
        if(StringUtils.equalsIgnore(contentType, Constants.DEFAULT_CONTENT_TYPE_VAL)) {
        ...
        if(StringUtils.equalsIgnore(contentType, Constants.JSON_CONTENT_TYPE_VAL)) {
